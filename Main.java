...
public class Main extends Application {
	...
	private void initMainStage() {
		try {
			...
			this.primaryStage.setWidth(1220);
			this.primaryStage.setMinHeight(838);
	...
	public boolean mostarContatoDialog2(Notation notation) {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(Main.class.getResource("gui/editarNota.fxml"));
			AnchorPane page = (AnchorPane) loader.load();
			
			Stage dialogStage = new Stage();
			dialogStage.setTitle("Editar Notation");
			dialogStage.initModality(Modality.WINDOW_MODAL);
			dialogStage.initOwner(this.primaryStage);
